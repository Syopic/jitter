angular.module('ira').controller("TestCtrl", ['$scope', '$timeout', function ($scope, $timeout) {
  ...
  //////////////----------------------
    $scope.$watch('distinctDef', function () {
      ...
      $scope.tabName = $scope.distinctDef;
      $scope.labelsHor = $scope.distinct;
    ...
    $scope.dashboardLabelsDough =  ["Red", "Blue", "Yellow", "Green", "Purple", "Orange"];
    ...
    $scope.dashboardTwoSeries = ['GenXpert Errors'];
    ...
    $.getJSON('data/tabletest.json', function (dashboard) {
        ...
        for (var i in dashboardSel) {
            ...
            $scope.dashboardTwoData = [$scope.dashboardTwoDat];
        }
